...
def __distance_inv_wei(L: NDArray) -> NDArray:
    """
...
def efficiency(W: NDArray) -> tuple[float, NDArray]:
    """
    ...
    Nodally/Locally is the same as globally but calculated on the
    neighbourhood of the node, and is related with clustering coefficient.
    ...
    ...               [1., 0., 1.],
    ...               [2., 1., 0.]])
    >>> global_eff, nodal_eff = efficiency(W)
    >>> nodal_eff.shape
    (3,)
