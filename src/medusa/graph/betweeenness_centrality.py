...
def betweenness(W: NDArray, norm: bool = True) -> NDArray:
    """
    Calculates the betweenness centrality of the graph, which is the
    probability that node i belongs to one of the graph shortest paths
