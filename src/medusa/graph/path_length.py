...
def __charpath(
    D: NDArray,
    diagonal_dist: bool | None = None,
    infinite_dist: bool | None = None,
    ...
    ----------
    D : numpy 2D matrix
        Distance matrix. ChannelsXChannels.
    diagonal_dist :
        Distances on the main diagonal. Optional. Default: diagonal_dist = 0
    infinite_dist :
        Include infinite distances in calculations. Optional.
...
def __distance_wei(L: NDArray) -> tuple[NDArray, NDArray]:
    """
...
def path_length(
    ...
    diagonal_dist :
        Include the main diagonal distances. Optional. Default: 0.
    infinite_dist :
        Include infinite distances in calculations. Optional. Default: 1.
    ...
    if not infinite_dist == None:
        infinite_dist = infinite_dist.astype(bool)
    if not diagonal_dist == None:
        diagonal_dist = diagonal_dist.astype(bool)
