...
def modularity(W: NDArray, gamma: float = 1.0) -> tuple[float, NDArray]:
    """
    Calculates the optimal node comunity and the modularity

    Note: The optimal community structure subdivides the graph into groups of
    ...
    while U[0]: # Community U[0]
        ...
        if q > 10**-10: # Contribution positive: U[0] is divisible
            ...
            Bg[np.eye(Ng,dtype=bool)] = 0 # To enable fine-tuning, modify Bg
